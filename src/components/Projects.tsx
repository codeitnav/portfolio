...
const projects = [
  {
    ...
    description: "Your all-in-one solution to effortlessly manage, analyze, and optimize your personal finances with powerful AI-driven features",
    image: finance,
  ...
  },
  {
    ...
    description: "A minimal and modern blogging website to share stories, insights, and creative content with readers around the world",
    image: blog,
  ...
  },
  {
    ...
    description: "An interactive web app that lets users create secure, random passwords with customizable options like numbers and special characters, and copy them with a click",
    image: pass_img,
  ...
  },
  {
    ...
    description: "A responsive and user-friendly web app enabling real-time conversion between 300+ global currencies",
    image: curr_img,
